...
GECKO_STRINGS=${CURDIR}/firefox-l10n-source
L10N_CENTRAL=${CURDIR}/firefox-l10n
MJ_GIT_REPO=${CURDIR}/gecko-l10n
...
${PYTHON_EXE} ${CURDIR}/slackbot.py ${GECKO_STRINGS}/_configs/browser.toml ${MJ_GIT_REPO} ${L10N_CENTRAL}
